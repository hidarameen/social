class StorageKeys {
  ...
  static const String shellSidebarCollapsed = 'socialflow_shell_sidebar_collapsed_v1'; // '1' | '0'
  static const String shellReducedMotion = 'socialflow_shell_reduced_motion_v1'; // '1' | '0'
  static const String shellDensity = 'socialflow_shell_density_v1'; // 'comfortable' | 'compact'

  static const String notificationsEmailOnSuccess = 'socialflow_notifications_email_success_v1'; // '1' | '0'
  static const String notificationsEmailOnError = 'socialflow_notifications_email_error_v1'; // '1' | '0'
  static const String notificationsPushEnabled = 'socialflow_notifications_push_v1'; // '1' | '0'
